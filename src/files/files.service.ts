...
export class FilesService {
  ...
  async uploadFile(userId: number, file: Express.Multer.File, folderId?: number) {
    ...
    // Use the actual filename generated by Multer's diskStorage
    // This avoids a mismatch between what's stored on disk and what's recorded in DB
    const storedFilename = file.filename; // set by FileInterceptor's diskStorage
